...
\listoftables
 ...
 When dealing with rectangled triangles (see Figure \ref{triangle}) I sometimes used this theorem from \citep{pythm001}:
...
Unless there is a bug in my program, which is unlikely, this research indicates that the whole theory on triangles having 3 sides has been wrong for years, maybe decades.
 ...
 \begin{proof}
\eqref{theo} was already demonstrated in \citep{euclides300}.
\end{proof}
