...
%\videoOSX	% for OS X 
%  \videoOFF % to disable videos and display image instead
...
\begin{frame}{Citations}
 \begin{itemize}[<+->]
  ...
  \end{itemize}\vfill
  \item Can also be put in footline \footnote{\smallcite{pythm001}}
 \end{itemize}
\end{frame}
...
\begin{center}
\includevideo{saddle_octopus.mp4}{posters/saddle_octopus.jpg}{.5\linewidth}{0.528\linewidth}
\end{center}
\end{frame}
